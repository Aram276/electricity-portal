      ...
      {showText && (
        <div className={textClassName}>
          <div className="flex items-center gap-2">
            <span className="text-[10px] sm:text-xs font-bold px-2.5 py-0.5 rounded-full bg-gradient-to-r from-amber-500/20 to-yellow-500/10 text-amber-300 border border-amber-500/30">
          ...
          <div className="text-lg sm:text-xl font-black tracking-tight text-white flex items-center gap-2 mt-0.5">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-500">
              پڕۆژەی ڕووناکی
            </span>
            <span className="text-[11px] font-bold px-2 py-0.5 rounded-md bg-cyan-950/80 text-cyan-300 border border-cyan-500/30 hidden md:inline-block">
              کارەبای ٢٤ کاتژمێری
            </span>
          </div>
        </div>
